...
public class MenuActivity extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (PrefUtil.GetStringPref(MenuActivity.this, "username").equals("")
				&& PrefUtil.GetStringPref(MenuActivity.this, "password")
						.equals("")) {
	...
	public OnClickListener Browser_Action = new OnClickListener() {
		...
		public void onClick(View v) {
			Intent browser = new Intent(MenuActivity.this,
					TabBrowserActivity.class);
	...
	public void ShowDialogLogin() {
		final EditText dialog_username = (EditText) mDialog
				.findViewById(R.id.login_username);
		final EditText dialog_password = (EditText) mDialog
				.findViewById(R.id.login_pass);
		final CheckBox show_password = (CheckBox) mDialog
				.findViewById(R.id.login_showpassword);
		show_password.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				if (show_password.isChecked()) {
					...
					dialog_password.setInputType(InputType.TYPE_CLASS_TEXT
							| InputType.TYPE_TEXT_VARIATION_PASSWORD);
				}
			}
		});
		Button dialog_login = (Button) mDialog.findViewById(R.id.login_ok);
		Button dialog_register = (Button) mDialog
				.findViewById(R.id.login_register);
		dialog_login.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Thread t = new Thread() {
					public void run() {
						flag = mEngine.login(dialog_username.getText()
								.toString(), dialog_password.getText()
								.toString());
						PrefUtil.SetPref(MenuActivity.this, "username",
								dialog_username.getText().toString());
						PrefUtil.SetPref(MenuActivity.this, "password",
								dialog_password.getText().toString());
						PrefUtil.SetPref(MenuActivity.this, "xu", mEngine
								.GetXu(dialog_username.getText().toString(),
										dialog_password.getText().toString()));
		...
		dialog_register.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent register = new Intent(MenuActivity.this,
	...
	public void onClick(View v) {
		if (!flag) {
			...
			case R.id.menu_payment:
				Intent payment = new Intent(MenuActivity.this,
						PaymentActivity.class);
				startActivity(payment);
				break;
			case R.id.menu_save_search:
				Intent search = new Intent(MenuActivity.this,
						SavedSearchActivity.class);
				startActivity(search);
				break;
			case R.id.menu_favorite:
				Intent favourite = new Intent(MenuActivity.this,
						FavouriteActivity.class);
				startActivity(favourite);
				break;
			case R.id.menu_my_account:
				Intent myaccount = new Intent(MenuActivity.this,
	...
	public void onDismiss(DialogInterface dialog) {
		...
		if (flag) {
			Toast.makeText(MenuActivity.this,
					getString(R.string.menu_successful), Toast.LENGTH_LONG)
					.show();
			mLogin.setText(R.string.menu_logout);
			mDialog.cancel();
		} else {
			Toast.makeText(MenuActivity.this, getString(R.string.menu_fail),
