	...
	public class FavouriteAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			TextView name = (TextView) convertView
					.findViewById(R.id.item_favourite_name);
			TextView datesaved = (TextView) convertView
					.findViewById(R.id.item_favourite_datesaved);
			TextView content = (TextView) convertView
					.findViewById(R.id.item_favourite_content);
			ImageView image = (ImageView) convertView
					.findViewById(R.id.item_favourite_image);
			TextView price = (TextView) convertView
					.findViewById(R.id.item_favourite_buy);
			TextView promotionprice = (TextView) convertView
					.findViewById(R.id.item_favourite_buyend);
			TextView provider = (TextView) convertView
					.findViewById(R.id.item_favourite_provider);
			CheckBox flag = (CheckBox) convertView
					.findViewById(R.id.item_favourite_flag);
			mData.moveToPosition(position);
			name.setText(mData.getString(mData.getColumnIndex("id")) + " - "
					+ mData.getString(mData.getColumnIndex("name")));
			datesaved.setText(getString(R.string.saved_date) + " "
					+ mData.getString(mData.getColumnIndex("savedate")));
			content.setText(mData.getString(mData
			...
			promotionprice.setText("$"
					+ mData.getString(mData.getColumnIndex("buyprice")));
			provider.setText(getString(R.string.provider) + " "
					+ mData.getString(mData.getColumnIndex("provider")));
			BitmapManager.INSTANCE
					.loadBitmap(
							mEngine.URL_Image
									+ mData.getString(mData
