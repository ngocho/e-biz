...
public class ActiveXU extends BaseAction {
	...
	private String activexu_stp(String content){
	...
	private String activexu_sca(String content){
		String[] listitem=content.split("@");
	...
	private String buy_scb(String content){
		String result="false";
		String[] listitem=content.split("@");
		try {
	...
	private String buy_stb(String content){
		String result="false";
		String[] listitem=content.split("@");
		try {
			//    		Customer tem=new Customer();
	...
	private String activexu_scn(String content){
		String[] listitem=content.split("@");
		long tempmoney=Long.parseLong(listitem[1]+"000");
		String result="false";
		try {
