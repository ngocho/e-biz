...
public class NL_Checkout {
    ...
    public String buildCheckoutUrl(String return_url, String receiver, String order_code, String price,
        ...
        secure_code = this.merchant_site_code.toString() + " " + URLEncoder.encode(return_url).toLowerCase() + " "
                + receiver.toString() + " " + transaction_info.toString() + " " + order_code.toString() + " "
                + price.toString();
    ...
    public Boolean verifyPaymentUrl(String transaction_info, String order_code, String price, String payment_id,
        ...
        verify_secure_code = " " + transaction_info.toString() + " " + order_code.toString() + " " + price.toString()
                + " " + payment_id.toString() + " " + payment_type.toString() + " " + error_text.toString().trim();
