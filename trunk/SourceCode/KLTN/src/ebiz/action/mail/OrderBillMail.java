    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        if (idOrder != null) {
            ...
            if (bill != null) {
                ...
                msgBody.append("</li>");
                msgBody.append("<li>");
                msgBody.append("Tổng số tiền: " + bill.getSumPrice());
                msgBody.append("</li>");
                msgBody.append("<li>");
                msgBody.append("Thời gian giao hàng: " + bill.getDateShip());
                msgBody.append("</li>");
                msgBody.append("<li>");
                msgBody.append("Địa chỉ giao hàng: " + CustomerBLO.toStringAddres(bill.getAddress()));
                msgBody.append("</li>");
                msgBody.append("</ul>");
                msgBody.append("</body>");
